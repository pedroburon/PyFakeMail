...
def main():
    ...
    parser.add_option('-j', '--just-smtp', action='store_true', dest='smtp', default=False,
                        help='Just run fake smtp server')
    parser.add_option('-S', '--smtp-host', dest='smtp_host', type='string', default='localhost',
                        help='Set local smtp host')
    parser.add_option('-s', '--smtp-port', dest='smtp_port', type='int', default=9969,
                        help='Set local smtp port')
    parser.add_option('-W', '--http-host', dest='http_host', type='string', default='127.0.0.1',
                        help='Set http host')
    parser.add_option('-w', '--http-port', dest='http_port', type='int', default=9999,
                        help='Set http port')
